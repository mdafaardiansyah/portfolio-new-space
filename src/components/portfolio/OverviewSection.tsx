  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          className="absolute top-10 md:top-20 right-4 md:right-16 text-2xl md:text-4xl opacity-15 md:opacity-25"
          animate={{
            y: [-20, 20, -20],
            x: [-10, 10, -10],
            rotate: [0, 360]
        ...
        <motion.div
          className="absolute bottom-8 md:bottom-16 left-4 md:left-16 text-3xl md:text-5xl opacity-20 md:opacity-30"
          animate={{
            y: [-15, 15, -15],
            scale: [1, 1.2, 1],
            rotate: [0, 360]
        ...
        <motion.div
          className="hidden md:block absolute top-1/2 left-1/3 text-2xl opacity-20"
          animate={{
            x: [-25, 25, -25],
            y: [-10, 10, -10],
            rotate: [0, 180, 360]
        ...
        <motion.div
          ...
          animate="animate"
          className="absolute top-10 md:top-20 right-4 md:right-16 w-16 md:w-24 h-16 md:h-24 bg-gradient-to-br from-indigo-400/20 md:from-indigo-400/30 to-purple-400/20 md:to-purple-400/30 rounded-full blur-xl md:blur-4xl"
        />
        <motion.div
          variants={floatVariants}
          animate="animate"
          style={{ animationDelay: "3s" }}
          className="absolute bottom-8 md:bottom-16 left-4 md:left-16 w-24 md:w-40 h-24 md:h-40 bg-gradient-to-br from-cyan-400/15 md:from-cyan-400/20 to-teal-400/15 md:to-teal-400/20 rounded-full blur-xl md:blur-2xl"
        />
        <motion.div
          variants={floatVariants}
          animate="animate"
          style={{ animationDelay: "6s" }}
          className="hidden md:block absolute top-1/2 left-1/3 w-16 h-16 bg-gradient-to-br from-purple-400/25 to-pink-400/25 rounded-full blur-xl"
        />
      </div>
          ...
          >
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="relative p-4 md:p-6 lg:p-8 rounded-2xl md:rounded-3xl bg-gradient-to-br from-white/90 to-white/50 dark:from-gray-800/90 dark:to-gray-900/50 backdrop-blur-xl border border-white/30 dark:border-gray-700/40 shadow-2xl">
                ...
                <div className="absolute top-4 md:top-6 right-4 md:right-6 w-3 md:w-4 h-3 md:h-4 bg-green-400 rounded-full animate-pulse shadow-lg"></div>
                <div className="absolute top-4 md:top-6 right-10 md:right-14 w-2 md:w-3 h-2 md:h-3 bg-blue-400 rounded-full animate-pulse delay-300 shadow-md"></div>
                <div className="hidden md:block absolute top-6 right-20 w-2 h-2 bg-purple-400 rounded-full animate-pulse delay-500 shadow-md"></div>
                <motion.div 
                  className="absolute top-2 right-2 text-lg opacity-30"
                ...
                <div className="space-y-4 md:space-y-6">
                  <div>
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 md:mb-4 text-gray-900 dark:text-white flex items-center gap-2 md:gap-3">
                      ...
                      Greetings from Space! I&apos;m Muhammad Dafa Ardiansyah
                    </h3>
                  ...
                  <div className="border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    <h4 className="font-bold text-gray-900 dark:text-white mb-3 md:mb-4 flex items-center gap-2">
                      <Icon icon="solar:rocket-bold" className="text-yellow-500 w-4 md:w-5 h-4 md:h-5" width={20} height={20} />
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4 space-y-6 mt-6 lg:mt-0">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                <motion.a
                  href="mailto:ardidafa21@gmail.com"
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">ardidafa21@gmail.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">glanze.space</div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">Surabaya, Indonesia</div>
                  </div>
                </motion.div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-50/90 to-cyan-50/90 dark:from-emerald-950/30 dark:to-cyan-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              <h4 className="font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                <Icon icon="solar:planet-bold" className="text-emerald-600 w-5 h-5" width={20} height={20} />
